...
![image](https://github.com/user-attachments/assets/5cb854c1-1ac9-4890-8ff3-e018c1485ed7)
...
2. `Browser.java`: The main application class that sets up the browser window and tab management.
3. `SinglePage.java`: Represents a single browser tab with web view and navigation controls.
4. `ImageButton.java`: A custom button class for creating buttons with images.
...
`SinglePage` represents an individual browser tab. It includes:
